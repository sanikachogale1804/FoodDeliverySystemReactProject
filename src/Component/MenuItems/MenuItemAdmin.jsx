...
function MenuItemAdmin({ name, price, description, image }) {
      ...
      <div className="Item-container col-md-6 mb-4">
        <div className="card menu-card ">
          ...
          <div className="card-body">
            <h5 className="card-title menu-name">Hello {name}</h5>
            ...
            <a href="#" className="btn btn-primary btn-lg menu-btn">Update</a>
